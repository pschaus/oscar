 ...
 */
object StableMarriage extends CPModel with App  {
    // data
    //
    ...
    // variables
    val wife    = Array.fill(n)(CPIntVar(0 to n-1))
    val husband = Array.fill(n)(CPIntVar(0 to n-1))
    //
    // constraints
    //
    var numSols = 0
      ...
      //  post(rankWomen[w,o] < rankWomen[w,husband[w]] =>
